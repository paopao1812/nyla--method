...
const meals = {
  Desayunos: [
    ...
    {
      title: "Tostadas con atún",
      items: [
        "1 lata de atún en agua",
        "2 tostadas integrales",
        "30 g queso fresco light",
        "Tomate",
      ],
      protein: "30 g proteína",
      calories: "390 kcal",
    },
  ],
...
const supplements = [
  {
    title: "Proteína Whey",
    text:
      "Ayuda a llegar a la proteína diaria, favorece recuperación y saciedad.",
    dose: "1 scoop · 20–25 g proteína",
  },

  {
    title: "Creatina monohidrato",
    text:
      "Apoya fuerza, rendimiento, recuperación y energía muscular.",
    dose: "3–5 g diarios",
  },

  {
    title: "Omega 3",
    text:
      "Puede apoyar salud cardiovascular, inflamación, cerebro y recuperación.",
    dose: "Según indicación del producto o profesional",
  },

  {
    title: "Magnesio",
    text:
      "Puede apoyar descanso, sistema nervioso, recuperación y fatiga.",
    dose: "Consultar dosis adecuada",
  },
];
...
export default function Meals() {
  ...
  return (
    <section className="meals-screen">
      <p className="meals-eyebrow"></p>

      
<p className="section-label">Ideas para nutrirte</p>
      ...
      <div className="nutrition-note">
        ...
        <p>
          Estas ideas son educativas y generales.
          Si tienes una condición médica,
          necesidades específicas o quieres un plan personalizado,
          consulta con un profesional en nutrición o salud.
        </p>
